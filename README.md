...
<br>
<br>
4륜 전동 킥보드로 주제 선정하였다. 기본적인 골자는 시중에 많이 나와있는 2륜 킥보드가 아닌 4륜 킥보드 제작하기로 결정.<br>
...
<br>
동력장치는 허브모터를 사용해야 될 것으로 판단된다. <br> 배터리는 리튬이온 전지 혹은 납배터리를 사용할 예정!!<br>
재료비 어느정도인지 알아볼 것!<br>
허브모터 알아보것! <br>
...
전동 킥보드가 아닌 전동 인라인 스케이트로 주제 변경 기존에 소장하고 있던 인라인 스케이트를 가지고 설계 하기로 결정. <br>
모터의 가격이 생각보다 비싸다,,, <br>
한쪽 발에만 모터를 장착하는 방향으로 최종 의사결정하였다,,<br>
<br>
<br>
